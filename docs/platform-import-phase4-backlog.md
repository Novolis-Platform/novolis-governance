...
|------|------|--------------|----------|
| 4.1 | `novolis-workflow-engine` | `Frank.WorkflowEngine` | **Extracted locally; GPR release pending.** `novolis-mapping`, `novolis-scheduling`, messaging facade (`novolis-workflows` = GitHub Actions only) |
