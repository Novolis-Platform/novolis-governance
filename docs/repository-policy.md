...
- Production desktop apps live in [novolis-apps](https://github.com/Novolis-Platform/novolis-apps); integration smoke apps in [novolis-dogfooding](https://github.com/Novolis-Platform/novolis-dogfooding). Library repos must not host product `apps/` — packable `src/`, tests, and `tools/` only. See [apps-repos.md](apps-repos.md).
