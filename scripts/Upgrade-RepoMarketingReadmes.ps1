...
$catalog = @{
    ...
    'novolis-experimental'    = @{ Tag = 'Skunkworks extracts'; Blurb = 'Experimental tooling (XWA, Galactic, …) — not published NuGet packages.'; Desc = 'Experimental Novolis tooling (XWA, Galactic) — not published packages.'; Topics = @('dotnet','experimental','novolis') }
