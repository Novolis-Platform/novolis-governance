...
$catalog = @{
    ...
    'novolis-utilities'       = @{ Tag = 'Small technical executables'; Blurb = 'No-installer utilities for files, wires, devices, and focused technical jobs.'; Desc = 'Small technical executable utilities for the Novolis ecosystem; no installers.'; Topics = @('dotnet','utilities','tools','novolis') }
    ...
    'novolis-lab'             = @{ Tag = 'Fast integration labs'; Blurb = 'Quick experiments, package demos, smokes, and benchmarks for the Novolis platform.'; Desc = 'Fast Novolis integration labs with a graduate path to tools, utilities, and apps.'; Topics = @('dotnet','samples','labs','novolis') }
    ...
    'novolis-install'         = @{ Tag = 'Archived installer host'; Blurb = 'The `novolis` tool host moved to novolis-tools.'; Desc = 'Archived repository; the Novolis installer tool is now published from novolis-tools.'; Topics = @('dotnet','cli','installer','novolis') }
    ...
    'novolis-maui'            = @{ Tag = 'MAUI Markdown and Mermaid'; Blurb = 'MAUI viewers that compose Novolis.Markup — the Avalonia-equivalent island.'; Desc = 'MAUI UI libraries for Novolis Markdown, Mermaid, and locked-down WebViews.'; Topics = @('dotnet','maui','markdown','mermaid','novolis') }
...
foreach ($dir in ($repoDirs | Sort-Object Name)) {
    ...
    $skipPkgReadmeRepos = @('novolis-apps', 'novolis-utilities', 'novolis-lab', 'novolis-experimental', 'novolis-template-dotnet', '.github', 'novolis-governance', 'novolis-workflows', 'novolis-registry')
    $skipPackageIndexRepos = @('novolis-apps', 'novolis-utilities', 'novolis-lab', 'novolis-experimental', 'novolis-template-dotnet', '.github', 'novolis-governance', 'novolis-workflows', 'novolis-registry', 'novolis-mapping', 'novolis-scheduling', 'novolis-wirefish')
