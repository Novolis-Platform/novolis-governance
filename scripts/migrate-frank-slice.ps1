...
$replacements = @(
    ...
    'Frank.Security.Cryptography|Novolis.Security.Secrets',
    'Frank.Security.Resources|Novolis.Security.WordLists',
    ...
    'Frank.ML.Domain.Racing|Novolis.Simulation.Racing',
    'Frank.ML.Domain.MlPipeline|Novolis.MachineLearning.AutoMl',
